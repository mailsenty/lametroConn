...
/**
 * A <code>LaMetroConnConnectorMetadataAdapter</code> is a wrapper around {@link LaMetroConnConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-09T01:49:46-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class LaMetroConnConnectorMetadataAdapter
    extends LaMetroConnConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "LaMetroConn";
