...
/**
 * A <code>LaMetroConnConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link LaMetroConnConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-09T01:49:46-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class LaMetroConnConnectorLifecycleInjectionAdapter
    extends LaMetroConnConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(LaMetroConnConnectorLifecycleInjectionAdapter.class);
