...
public class GetRouteMessageProcessorDebuggable
    extends GetRouteMessageProcessor
    implements DebugInfoProvider
{


    public GetRouteMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("routeNo", "Route no", (java.lang.String.class), routeNo, muleEvent));
