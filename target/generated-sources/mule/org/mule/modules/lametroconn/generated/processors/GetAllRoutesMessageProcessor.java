...
/**
 * GetAllRoutesMessageProcessor invokes the {@link org.mule.modules.lametroconn.LaMetroConnConnector#getAllRoutes()} method in {@link LaMetroConnConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-09T01:49:46-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class GetAllRoutesMessageProcessor
    extends DevkitBasedMessageProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{


    public GetAllRoutesMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((LaMetroConnConnector) object).getAllRoutes();
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at LaMetroConnConnector at getAllRoutes retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
